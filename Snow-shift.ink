...
= assign_nadya
    ...
    + {zone_6_accessible and zone_3_accessible} [Доставить запчасть в Клуб (3)]
        ...
        -> assignment_loop
    + {zone_6_accessible and zone_7_accessible} [Доставить запчасть к шнекоротору А]
        ~ nadya_task = "deliver_part_to_shnek_A"
        -> assignment_loop
    + {zone_6_accessible and zone_2_accessible} [Доставить запчасть к шнекоротору B]
        ~ nadya_task = "deliver_part_to_shnek_B"
        -> assignment_loop
    + {zone_6_accessible and zone_9_accessible} [Доставить запчасть к шнекоротору C]
...
# clear
 ...
 ВОСКОБОЙНИКОВЫ, из Традиции Конструкторов. Но их сын Артем — "белая ворона" в семье. Его сердце принадлежит не механизмам, а биологии и его экспериментальным персикам в теплице. А его сестрички-близняшки — Соня и Тоня — главный источник работы для медпункта, ведь они умудряются найти приключения на ровном месте.
...
Этой ночью буран оказался сильнее, чем предсказывали все симуляторы. Надя проснулась от воя сирены. Тревожный сигнал с Теплостанции. Отказ генератора. Обрыв связи с Медпунктом.
...
# clear
Огромный спасательный дирижабль приземляется на центральной площади. Из него выходит капитан Урсан Буреломов — молодой, но уже опытный медведь в форме спасательной службы. Он всего на пару зим старше ее. Он осматривает потрепанный, но не сломленный поселок и подходит к измотанной Наде.
...
#Location: Центральная площадь
# clear
(Капитан спасателей получает отчет от своего помощника, такого же подростка в форме.) Помощник: Урсан... Ой, простите, капитан! Странная ситуация — нас вызывали на помощь, большинство систем было выведено из строя, но... кажется, вахтенные многое смогли наладить. Дети в безопасности, заняты делом, критические системы все в порядке. #У
...
Статус победы: стабилизация, 2 звезды! Надя безусловно справилась со своей вахтой и смогла очень многое наладить. Она не ошиблась с выбором Традиции, Первопроходцев, и в будущем сможет взять на себя еще более сложные задачи. Поздравляем!
-> END
...
Статус победы: все цели достигнуты, 3 звезды. О Наде Следопытовой расскажут в новостях, а ее победу над стихией и хаосом станут приводить в пример другим медвежатам-подросткам. Капитан Буреломов прав, её опыт станет основой для тренировок будущих ответственных за такие вахты. Поздравляем с успехом!
-> END
